        ...
        <header className="relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 py-20 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center mb-12">
              <Link
                href="get-started"
                className="bg-blue-600 text-white px-6 py-3 rounded-lg text-base font-semibold hover:bg-blue-700 transition flex items-center justify-center gap-2"
              ...
              <a
                ...
                className="bg-green-600 text-white px-6 py-3 rounded-lg text-base font-semibold hover:bg-green-700 transition flex items-center justify-center gap-2"
                aria-label="Chat with us on WhatsApp for medical tourism inquiries"
              >
                <svg
